...
#include <memory>
#include "../ParkingManagementSystem/adduser.h"
...
QT_MOC_LITERAL(3, 18, 13), // "addUserSignal"
QT_MOC_LITERAL(4, 32, 12), // "showAndClean"
QT_MOC_LITERAL(5, 45, 23), // "on_pushButton_2_clicked"
QT_MOC_LITERAL(6, 69, 21) // "on_pushButton_clicked"

    },
    "addUser\0menuShow\0\0addUserSignal\0"
    "showAndClean\0on_pushButton_2_clicked\0"
...
void addUser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->addUserSignal(); break;
        case 2: _t->showAndClean(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&addUser::menuShow)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (addUser::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&addUser::addUserSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void addUser::menuShow()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void addUser::addUserSignal()
{
