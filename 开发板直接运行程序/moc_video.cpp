...
#include <memory>
#include "../ParkingManagementSystem/video.h"
...
QT_MOC_LITERAL(1, 6, 9), // "sendCarID"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 3), // "str"
QT_MOC_LITERAL(4, 21, 9), // "sendFrame"
QT_MOC_LITERAL(5, 31, 3) // "pix"

    },
    "Video\0sendCarID\0\0str\0sendFrame\0pix"
};
...
void Video::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendCarID((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->sendFrame((*reinterpret_cast< QPixmap(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Video::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Video::sendCarID)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Video::*)(QPixmap );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Video::sendFrame)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Video::sendCarID(QString _t1)
{
...
// SIGNAL 1
void Video::sendFrame(QPixmap _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
