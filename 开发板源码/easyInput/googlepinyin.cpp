...
bool GooglePinYin::open(const QString &dbPath)
{
   ...
   // QString pyPath = "E:/QTprogram/ParkingManagementSystem/QNotepad/QNotepad/easyInput/dict_pinyin.dat";
    qDebug()<< pyPath;

   // QString pyUserPath = "E:/QTprogram/ParkingManagementSystem/QNotepad/QNotepad/easyInput/dict_pinyin_user.dat";
